...
class DamageModel:
    ...
    # initialize model
    def __init__(self, case_dir, update="v2_1"):
        logger.info("Using model service version 2")

        self.result_dir = f"{case_dir}/"
        self.weight_path = f"mrcnn/v2/{update}"
        self.cfg = get_cfg()
        ...
        self.cfg.MODEL.ROI_HEADS.NUM_CLASSES = 40
    ...
    def get_prediction(self, img):
        ...
        majorDamages = [26, 7, 5]  # Replace, Dent major, Bumper replace
        mediumDamages = [4, 8, 6]  # Bumper fix, Dent medium, crack
        minorDamages = [9, 3, 37]  # Dent minor, Bumper dent, Scratch
